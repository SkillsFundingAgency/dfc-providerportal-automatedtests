...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "DFC-4806 Search For Qualification", "In order to Add a Qualification\r\nAs a provider\r\nI want to be able to search for a" +
                    " Qualification using LARS/QAN Reference Number", ProgrammingLanguage.CSharp, ((string[])(null)));
...
#line hidden
        ...
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Search for a Qualification by LARS/QAN Reference Number", new string[] {
                        "CI"});
#line 15
...
#line hidden
        ...
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Search for a Qualification when user enters an invalid search term", new string[] {
                        "CI"});
#line 23
this.ScenarioSetup(scenarioInfo);
#line 6
...
#line hidden
        ...
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Search for a Qualification using Qualification Name", new string[] {
                        "CI"});
#line 27
this.ScenarioSetup(scenarioInfo);
#line 6
...
#line hidden
        ...
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Select filters for Qualification Level", new string[] {
                        "CI"});
#line 35
this.ScenarioSetup(scenarioInfo);
#line 6
...
#line hidden
        ...
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Select filters for Awarding Body", new string[] {
                        "CI"});
#line 42
this.ScenarioSetup(scenarioInfo);
#line 6
...
#line hidden
        ...
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Clear filters when reset is clicked", new string[] {
                        "CI"});
#line 49
this.ScenarioSetup(scenarioInfo);
#line 6
