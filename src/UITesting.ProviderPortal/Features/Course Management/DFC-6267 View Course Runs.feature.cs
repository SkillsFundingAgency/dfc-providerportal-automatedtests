...
#line hidden
        ...
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Maximise all course runs for default Qualification Level on entering YC-three", new string[] {
                        "CI"});
#line 32
