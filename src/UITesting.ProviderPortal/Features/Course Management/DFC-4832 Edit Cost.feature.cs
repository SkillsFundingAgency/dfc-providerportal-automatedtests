...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "DFC-4832 Edit Cost", "In order to be able to change the course details\r\nAs a Provider\r\nI want to be abl" +
                    "e to change the course cost", ProgrammingLanguage.CSharp, ((string[])(null)));
...
#line hidden
        ...
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Update cost with valid value", new string[] {
                        "CI"});
#line 20
...
#line hidden
        ...
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Update cost with value more than 999999.99", new string[] {
                        "CI"});
#line 27
this.ScenarioSetup(scenarioInfo);
#line 7
...
#line 28
 testRunner.Given("I have selected a course run to update", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Given ");
#line 29
 testRunner.And("I have changed the cost to 9999999.99", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line 30
 testRunner.When("I Click Save leading to Error", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line 31
 testRunner.Then("the Error message for cost should be displayed Maximum value for cost is £999,999" +
...
#line hidden
        ...
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Update cost with a value without decimals", new string[] {
                        "CI"});
#line 34
this.ScenarioSetup(scenarioInfo);
#line 7
...
#line hidden
        ...
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Update cost with a value with one decimals", new string[] {
                        "CI"});
#line 41
this.ScenarioSetup(scenarioInfo);
#line 7
