...
namespace UITesting.ProviderPortal.Pages.Apprenticeships
{
    public class AddApprenticeshipPage : BasePage
    {
        ...
        {
            FormCompletionHelper.EnterText(ApprenticeshipInfo, info);
        ...
        public AddApprenticeshipPage EmailErrorDisplayed()
        {
        ...
        public AddApprenticeshipPage PhoneErrorDisplayed()
        {
